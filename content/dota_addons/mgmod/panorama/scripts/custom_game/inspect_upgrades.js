...
function UpdateInspector(table,tableKey,data) {
    CreateAbilityPanel(tableKey,data,"2");
    CreateAbilityPanel(tableKey,data,"3");
}

function CreateCatPanel(ability,parent) {
...
function CreateAbilityPanel(ability,data,team) {
    var team_panel = team_panels[team];
    var parent = CreateCatPanel(ability,team_panel);
